...
mascara = cv2.imread("C:\\Users\\wicki\\OneDrive\\Documentos\\Trabajos Graficacion\\baticara.png", cv2.IMREAD_UNCHANGED)  # Cargar PNG con transparencia

# Cargar el clasificador preentrenado de rostros
face_cascade = cv2.CascadeClassifier("C:\\Users\\wicki\\OneDrive\\Documentos\\haarcascade_frontalface_alt2.xml")
